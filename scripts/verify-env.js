...
const optionalEnvVars = [
  ...
  'DISABLE_EMAILS',
  'EXPORT_API_SECRET',
  'GUEST_PATIENT_ARTICLES_AUTO_PUBLISH',
  'WORDPRESS_PATIENT_SYNC_ENABLED',
  'WORDPRESS_SITE_URL',
  'WORDPRESS_USERNAME',
  'WORDPRESS_APPLICATION_PASSWORD',
  'WORDPRESS_PATIENT_CATEGORY_SLUG',
  'WORDPRESS_PATIENT_POST_STATUS',
  'WORDPRESS_PATIENT_SYNC_TIMEOUT_MS',
  'JWT_SECRET',
  'ENCRYPTION_KEY',
]
